...
def figure4_ablation():
    ...
    line1 = ax.plot(
        levels, f1_scores, "o-", linewidth=2, markersize=8, color="#2ca02c", label="F1 Score"
    )
    line2 = ax2.plot(
        levels, times, "s-", linewidth=2, markersize=8, color="#d62728", label="Time (s)"
    )
...
def figure5_scaling_analysis():
    ...
    ax.plot(
        ...
        linewidth=2,
        markersize=6,
        label="Hierarchical Energy (ours)",
        color="#2ca02c",
    )
    ax.plot(
        durations,
    ...
    ax.plot(
        ...
        linewidth=2,
        markersize=6,
        label="Pure Optimization",
        color="#1f77b4",
    )
    ax.plot(
        durations, time_dense, "d-", linewidth=2, markersize=6, label="Dense VLM", color="#d62728"
    )
...
def figure6_precision_recall_curve():
    ...
    ax.plot(
        ...
        linewidth=2,
        label="Hierarchical Energy (F1=0.89)",
        color="#2ca02c",
    )
    ax.plot(
        recall_points,
        precision_geometric,
        linewidth=2,
        label="Geometric Outlier (F1=0.82)",
        color="#ff7f0e",
    )
    ax.plot(
        recall_points, precision_dense, linewidth=2, label="Dense VLM (F1=0.93)", color="#d62728"
    )
    ax.plot(
        recall_points, precision_rules, linewidth=2, label="Rule-Based (F1=0.80)", color="#1f77b4"
    )
